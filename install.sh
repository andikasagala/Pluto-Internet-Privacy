...
case "$MyOsValueGlobal" in
	...
	2)
		...
		case "$UnixVerifierDebian" in
			2)
				if [ $UnixVerifierDebian -eq 2 -a $UnixVerifierantiX -eq 1 ]
				then
				echo "It is no problem."
				elif [ $UnixVerifierDebian -eq 2 -a $UnixVerifierKnoppix -eq 1 ]
				then
				echo "It is no problem."
                elif [ $UnixVerifierDebian -eq 2 -a $UnixVerifierantiX -ne 1 -a $UnixVerifierKnoppix -ne 1 ]
                then
