...
################# install Operating System requirement  done ########################
##################################################################################
...
case "$MyOSSettingValueMachine" in
	...
	ParrotOS)
		...
		echo "Your sysctl file sysctl was changed and saved in /etc/sysctl.conf.bak"
	;;
	################ setting sysctl Parrot OS done ###########################

	############### setting sysctl Fedora ###############################
	Fedora)
		...
		echo "`date`" - Setting machine done." " >> /var/log/earth.log
	;;
	############## setting sysctl Fedora done ###########################

	################ setting sysctl openSUSE ##########################
	openSUSE)
...
case "$MyOSSettingValueHosts" in
	...
	DebianCommon)
		...
		echo "`date`" - Setting hosts done." " >> /var/log/earth.log
	;;
	################ setting hosts Debian done ########################


	############## setting hosts Manjaro Linux ###############################
	ManjaroLinux)
		...
		echo "`date`" - Setting hosts done." " >> /var/log/earth.log
	;;
	################### setting hosts Manjaro Linux done ######################

	############### setting hosts Parrot OS #######################
	ParrotOS)
		...
		echo "`date`" - Setting hosts done." " >> /var/log/earth.log
	;;
	#################### setting hosts Parrot OS done ###########


	############# setting hosts Fedora ##############################
	Fedora)
		...
		echo "`date`" - Setting hosts done." " >> /var/log/earth.log
	;;
	################ setting hosts Fedora done #######################

	############ setting hosts openSUSE ##################################
	openSUSE)
...
case "$MyOSSettingValueSquid" in
	...
	;;
	################# setting squid FreeBSD done #############################


	################# setting squid Debian ####################################
	DebianCommon)
	...
	ManjaroLinux)
		...
		echo "`date`" - Setting Squid done." " >> /var/log/earth.log
	;;
	###################### setting squid Manjaro Linux done ##########################################################

	################## setting squid Parrot OS #########################################################
	ParrotOS)
		...
		echo "`date`" - Setting Squid done." " >> /var/log/earth.log
	;;
	############### setting squid Parrot OS done ############################

	############## setting squid Fedora ######################################
	Fedora)
		...
		echo "`date`" - Setting Squid done." " >> /var/log/earth.log
	;;
	################ setting squid Fedora done #############################################

	################## setting squid openSUSE ########################################
	openSUSE)
...
case "$MyOSSettingValuePrivoxy" in
	...
	ManjaroLinux)
		...
		echo "`date`" - Setting Privoxy done." " >> /var/log/earth.log
	;;
	################# setting privoxy Manjaro Linux done #############################

	############## setting privoxy Parrot OS ################################
	ParrotOS)
		#Privoxy 1
		...
		echo "`date`" - Setting Privoxy done." " >> /var/log/earth.log
	;;
	################# setting privoxy Parrot OS done #######################

	############# setting privoxy Fedora ###################################
	Fedora)
		#Privoxy 1
		...
		echo "`date`" - Setting Privoxy done." " >> /var/log/earth.log
	;;
	################ setting privoxy Fedora done ###################################

	############### setting privoxy openSUSE #########################################
	openSUSE)
		#Privoxy 1
...
case "$MyOSSettingValueTor" in
	...
	ManjaroLinux)
		...
		echo "`date`" - Setting Tor done." " >> /var/log/earth.log
	;;
	############# setting tor Manjaro Linux done #################################

	################# setting tor Parrot OS ###################################
	ParrotOS)
	...
	Fedora)
		...
		echo "`date`" - Setting Tor done." " >> /var/log/earth.log
	;;
	################## setting tor Fedora done #######################

	################ setting tor openSUSE ##############################
	openSUSE)
